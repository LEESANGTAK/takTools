...
class SkinWeights(object):
    ...
    def ui(self):
        ...
        self.uiWidgets['conformMenuItem'] = cmds.menuItem(p=self.uiWidgets['editMenu'], label='Conform', c=skinUtil.conformSkin, ann='Conform skin weights for the selected faces.')
