...
def UI():
    ...
    cmds.shelfButton(annotation = 'Extract a curve for selected polygon edges.', width = 35, height = 35, imageOverlayLabel = '', image1 = 'polyEdgeToCurves.png', command = 'from imp import reload\nfrom takTools.utils import curve as crvUtil; reload(crvUtil)\ncrvUtil.extractCurveFromSelectedEdges()', sourceType = 'python')
    ...
    cmds.shelfButton(annotation = 'EP Curve Tool.', width = 35, height = 35, imageOverlayLabel = '', image1 = 'curveEP.png', command = 'EPCurveTool', sourceType = 'mel')
    ...
    cmds.shelfButton(annotation = 'Set up clusters for a selected curve.', width = 35, height = 35, imageOverlayLabel = '', image1 = 'selectCluster.png', command = 'from imp import reload\nfrom takTools.utils import curve as crvUtil; reload(crvUtil)\ncrvUtil.setupDriveClusters(cmds.ls(sl=True)[0])', sourceType = 'python')
    ...
    cmds.shelfButton(annotation = 'Build folding rig like a paper.', width = 35, height = 35, imageOverlayLabel = 'Fold', image1 = 'commandButton.png', command = 'source makeFoldingRig.mel;', sourceType = 'mel')
    cmds.shelfButton(annotation = 'Set up auto swim feature for FK controllers.', width = 35, height = 35, imageOverlayLabel = '', image1 = 'autoSwim.bmp', command = 'import takTools.rigging.tak_autoSwim as tak_autoSwim\nimport imp\nimp.reload(tak_autoSwim)\ntak_autoSwim.UI()', sourceType = 'python')
