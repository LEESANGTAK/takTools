...
def UI():
    ...
    cmds.shelfButton(annotation = 'from epic_pose_wrangler import main\npose_wrangler = main.PoseWra...', width = 35, height = 35, imageOverlayLabel = 'PoseWrangler', image1 = 'pythonFamily.png', command = 'from epic_pose_wrangler import main\npose_wrangler = main.PoseWrangler()', sourceType = 'python')
