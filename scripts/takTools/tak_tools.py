...
def UI():
    ...
    cmds.shelfButton(annotation = '', width = 35, height = 35, imageOverlayLabel = '', image1 = 'dembones.jpg', command = 'import dem_bones\ndem_bones.showUI()', sourceType = 'python')
    cmds.shelfButton(annotation = '', width = 35, height = 35, imageOverlayLabel = 'Editor', image1 = 'dembones.jpg', command = 'import imp\nimport editPoseGUI\nimp.reload(editPoseGUI)\ngui = editPoseGUI.EditPoseGUI()\ngui.show()', sourceType = 'python')
