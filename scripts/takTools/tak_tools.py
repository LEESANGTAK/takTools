...
def UI():
    ...
    cmds.shelfButton(annotation = 'Transfer skeleton from source mesh to target mesh.', width = 35, height = 35, imageOverlayLabel = 'Skeletor', image1 = 'HIKCharacterToolSkeleton.png', command = 'from imp import reload\nfrom takTools.rigging import automaticJointPlacement as autoJP;reload(autoJP)\nautoJP.openUI()', sourceType = 'python')
    cmds.shelfButton(annotation = "Epic Games's RBF pose space deformation setup tool.", width = 35, height = 35, imageOverlayLabel = 'PoseWrangler', image1 = 'createPose.png', command = 'from epic_pose_wrangler import main\npose_wrangler = main.PoseWrangler()', sourceType = 'python')
