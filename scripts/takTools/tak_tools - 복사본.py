...
def UI():
    ...
    cmds.shelfButton(annotation = 'Set Manager', width = 35, height = 35, imageOverlayLabel = '', image1 = 'objectSet.svg', command = 'import setManager as sm; reload(sm)\nsmGUI = sm.gui.ManagerGUI()\nsmGUI.show()', sourceType = 'python')
    ...
    cmds.shelfButton(annotation = 'AdvancedSkeleton', width = 35, height = 35, imageOverlayLabel = '', image1 = 'D:/tools/maya/AdvancedSkeleton/AdvancedSkeletonFiles/icons/AS.png', command = 'source "D:/tools/maya/AdvancedSkeleton/AdvancedSkeleton.mel";AdvancedSkeleton;', sourceType = 'mel')
    cmds.shelfButton(annotation = 'import takTools.rigging.advancedSkeletonHelperUI as ashUI\nimport imp\nimp.reload(ashUI)\n\n...', width = 35, height = 35, imageOverlayLabel = 'Helper', image1 = 'D:/tools/maya/AdvancedSkeleton/AdvancedSkeletonFiles/icons/AS.png', command = 'import takTools.rigging.advancedSkeletonHelperUI as ashUI\nimport imp\nimp.reload(ashUI)\n\ntry:\n    ashUIObj.close()\nexcept:\n    pass\n\nashUIObj = ashUI.AdvancedSkeletonHelperUI()\nashUIObj.show()\n', sourceType = 'python')
    cmds.shelfButton(annotation = '', width = 35, height = 35, imageOverlayLabel = '', image1 = 'D:/tools/maya/arise_main/py_2_7/arise/resources/icons/arise_logo_32pix.png', command = 'import sys\nimport os\n\nLOCAL_PATH = r"D:/tools/maya/arise_main"\nversion_folder = \'py_\' + str(sys.version_info.major) + \'_\' + str(sys.version_info.minor)\npath = os.path.join(LOCAL_PATH, version_folder)\n\nif path not in sys.path:\n    sys.path.append(path)\n\nfrom arise.ui_elements import ior_main_window\n\n# load UI.\ntry:\n    Win.deleteLater()\n    print("deleting old UI")\nexcept:\n    pass\n\nWin = ior_main_window.IORMainWindow(\n    parent_to_maya=None, # can be (True, False, None)\n    always_on_top=None, # can be (True, False, None)\n    log_feedback_level="info",\n    default_settings=False,\n    )\nWin.show_()\n', sourceType = 'python')
    ...
    cmds.shelfButton(annotation = 'Selector:biped', width = 35, height = 35, imageOverlayLabel = '', image1 = 'D:/tools/maya/AdvancedSkeleton/AdvancedSkeletonFiles/icons/asBiped.png', command = 'source "D:/tools/maya/AdvancedSkeleton/AdvancedSkeletonFiles/Selector/biped.mel";', sourceType = 'mel')
    cmds.shelfButton(annotation = 'Selector:face', width = 35, height = 35, imageOverlayLabel = '', image1 = 'D:/tools/maya/AdvancedSkeleton/AdvancedSkeletonFiles/icons/asFace.png', command = 'source "D:/tools/maya/AdvancedSkeleton/AdvancedSkeletonFiles/Selector/face.mel";', sourceType = 'mel')
    cmds.shelfButton(annotation = 'picker', width = 35, height = 35, imageOverlayLabel = '', image1 = 'D:/tools/maya/AdvancedSkeleton/AdvancedSkeletonFiles/picker/pickerFiles/icons/picker.png', command = 'source "D:/tools/maya/AdvancedSkeleton/AdvancedSkeletonFiles/picker/picker.mel";', sourceType = 'mel')
