...
#ifndef EXAMPLES_MATH_FLOAT3_UTILS_H
#define EXAMPLES_MATH_FLOAT3_UTILS_H
...
/// \param t The scalar.
/// \return The product in v1.
inline float3 operator*(float3 const& v1, const float t) {
    float3 res = {v1.x * t, v1.y * t, v1.z * t};
    return res;
}
...
inline float magSqr(const float3& v) { return v.x * v.x + v.y * v.y + v.z * v.z; }
...
inline float dist(const float3& v1, const float3& v2) { return mag(v1 - v2); }
...
#endif // EXAMPLES_MATH_FLOAT3_UTILS_H
